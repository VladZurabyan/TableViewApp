...
class AboutTableViewController: UITableViewController {
    ...
    let sectionContent = [["facebook", "vk", "youtube"], ["У нас нет пока сайта", ]]
    let firstSectionLinks = ["https://www.fb.com", "https://vk.com", "https://youtube.com"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        tableView.tableFooterView = UIView(frame: .zero)
        tableView.sectionHeaderHeight = CGFloat(60.1)
